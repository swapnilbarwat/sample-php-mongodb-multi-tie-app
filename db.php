	...
	*/
	...
	private function connect($config){
		try{
			...
			$connection=  new \Mongo("mongodb://50.203.224.6:27017,50.203.224.4:27017,50.203.224.9:27017/?replicaSet=pertinoreplica");
	    	return $this->db = $connection->selectDB("blog");
		}catch(Exception $e) {
			return false;
		}
	}
